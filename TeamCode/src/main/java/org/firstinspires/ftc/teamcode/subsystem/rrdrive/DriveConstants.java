...
public class DriveConstants {
    ...
    private static final MotorConfigurationType MOTOR_CONFIG =
            MotorConfigurationType.getMotorType(GoBILDA192Motor.class);
    ...
    public static double VELO_P = 25;
    public static double VELO_I = 5;
    public static double VELO_D = 10;


    public static final boolean RUN_USING_ENCODER = true;
    //public static final PIDCoefficients MOTOR_VELO_PID = null;
    public static final PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(VELO_P, VELO_I, VELO_D);
    ...
    public static double TRACK_WIDTH = 11.50;
